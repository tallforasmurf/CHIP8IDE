...
This class is used by source, assembler1, and assembler2.
...
A new instance is created if necessary, on a call to phase_one(), from the
syntax highlighter. The Statement object contains everything needed to
complete the assembly of that statement.
...
class Statement():
    ...
    def __init__( self ) :
        ...
        message is supplied as well. error_pos not None is another test for a
        valid statement.
        '''
        self.error_pos = None
        self.error_msg = ''
        ...
        recognized, self.form is a null string and self.text_error is True.
        '''
        self.form = ''
        '''
        ...
        of the name will be determined in assembler2.assemble(), at which
        time it is stored in the symbol table for access from expression
        evaluation. So the defined value is never kept in the Statement object.
        '''
        self.defined_name = ''
        '''
        ...
        When .form == 'ORG', set the PC to this value. Otherwise add this
        value to the PC.
        '''
        self.next_pc = 0
        '''
    ...
    def init_static( self ) :
        ...
        self.expressions = []
    '''
    Call this method to initialize the Statement prior to the assembly scan.
    Clear fields set during assembly, and an expression error if any. Don't
    clear text_error or error_msg or error_pos; those are either clear or
    set for a lexical error.
    '''
